       ...
       PROGRAM-ID. VRCB0130-NOTFOUND-TEST.
       ...
       PROCEDURE DIVISION.
           ...
           DISPLAY "========================================"
           DISPLAY " VRCB0130 CUSTOMER NOT FOUND TEST"
           DISPLAY "========================================"
           ...
           DISPLAY "Inquiry ID    : " WS-INQUIRY-ID
           DISPLAY "Return Code   : " OPERATION-RETURN-CODE
           DISPLAY "Severity      : " OPERATION-SEVERITY
           DISPLAY "Error Code    : " OPERATION-ERROR-CODE
           DISPLAY "Message       : " OPERATION-RETURN-MESSAGE

           IF OPERATION-RETURN-CODE = 01
               AND OPERATION-SEVERITY = "E"
               DISPLAY "CUSTOMER NOT FOUND PATH : PASS"
           ELSE
               DISPLAY "CUSTOMER NOT FOUND PATH : FAIL"
           END-IF
